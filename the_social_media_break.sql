...
--
-- Host: localhost
-- Generation Time: Jan 18, 2023 at 01:03 PM
...
--
-- Database: `the_social_media_break`
--
CREATE DATABASE IF NOT EXISTS `the_social_media_break` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `the_social_media_break`;
...
('5742xevdbm8m0cc3fx8p43kchkkd3mgf', 'eyJ1c2VyaWQiOjN9:1pI6fj:yEnVaTV9pD3411BgF7aG51xG8ffTzAy7xU184Tq-43k', '2023-02-01 11:32:03.958550'),
...
('qd2vk988noln4ux10c6sb9xh1l0g7j0q', 'eyJ1c2VyaWQiOjR9:1pI80k:aLVZTNib1kyrmFlMqRHrj8QxXE5mPNSO3qqA4KU6sls', '2023-02-01 12:57:50.803160'),
...
(4, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Viajaynagar', 'Male');
...
(53, 'Naive Bayes', '66.08676005422504'),
(54, 'Extra Tree Classifier', '61.793944871215544'),
(55, 'SVM', '73.38454586534117'),
(56, 'Logistic Regression', '75.57614098508812'),
(57, 'Decision Tree Classifier', '66.99051061906913');
...
(34, 'Negative', '33.33333333333333'),
(35, 'Positive', '16.666666666666664'),
(36, 'Anxious', '16.666666666666664'),
(37, 'Depression', '33.33333333333333');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_psycho_behavioral_measures`
--

CREATE TABLE IF NOT EXISTS `remote_user_psycho_behavioral_measures` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
